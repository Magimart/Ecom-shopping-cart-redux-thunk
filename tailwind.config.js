 ...
 const defaultTheme = require('tailwindcss/defaultTheme'); //  adding customized font family to tailwind default
 ...
 module.exports = {
     ...
     experimental: {
      ...
      theme: {
                // appending custom font family to default Snell Roundhand, cursive
               fontFamily: {
                ...
                screens: {
                          ...
                          xxs: { min: "320px", max: "475px" },
                          xs: { min: "475px", max: "640px" },
                          sm: { min: "640px", max: "767px" },
                          md: { min: "768px", max: "1023px" },
                          lg: { min: "1023px", max: "1279px" }, // changed from 1024px
                          xl: { min: "1279px" }, // changed from 1080px
                          //  3xl: { min: "1600px" },
                          xxsw: { min: "480px" }, // wide view
                          xsw: { min: "635px" }, // wide view
                },
                backgroundSize: {
                                  'cover': 'cover',
                                  'contain': 'contain',
